package computer.ethernet.onset.ui.tabs.settings
...
import computer.ethernet.onset.ui.VERSION_NAME
...
//                }
            ...
            CardWithTitle(title = "App", innerPaddingHorizontal = 0.dp) {
                SettingsButton(imageVector = Icons.Outlined.Code, text = "Source Code") {
                    uriHandler.openUri("https://github.com/ethernet8023/onset")
                }
                HorizontalDivider()
...
const val SHARE_APP_URL = "https://github.com/ethernet8023/onset"
